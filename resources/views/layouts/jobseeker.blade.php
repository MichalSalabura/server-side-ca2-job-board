...
<body>
    ...
    <nav class="navbar navbar-custom px-3 py-2 d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center gap-2">
            <a href="{{ route('jobseeker.profile.edit') }}" class="btn btn-sm btn-outline-purple">Profile</a>
        </div>
    </nav>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="sidebarMenu">
        ...
        <div class="offcanvas-body d-flex flex-column">
            <a href="{{ route('jobseeker.dashboard') }}" class="sidebar-btn outline">Dashboard</a>
            <a href="{{ route('job-listings.browse') }}" class="sidebar-btn">Browse Jobs</a>
            <a href="{{ route('jobseeker.applications') }}" class="sidebar-btn">My Applications</a>
